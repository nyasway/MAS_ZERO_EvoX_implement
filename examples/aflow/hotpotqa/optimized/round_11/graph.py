...
import examples.aflow.hotpotqa.optimized.round_11.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Review the selected solution using Custom operator
        reviewed_solution = await self.custom(
            input=f"solution:{final_solution['response']}, problem:{problem}", 
