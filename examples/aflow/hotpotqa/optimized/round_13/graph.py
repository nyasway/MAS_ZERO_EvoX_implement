...
import examples.aflow.hotpotqa.optimized.round_13.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        reviewed_solution = await self.custom(input=final_solution['response'], instruction=prompt_custom.REVIEW_PROMPT)
