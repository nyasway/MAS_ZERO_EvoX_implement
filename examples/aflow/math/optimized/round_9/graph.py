...
import examples.aflow.math.optimized.round_9.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        solutions = []
        max_retries = 3
        for _ in range(max_retries):  # Retry mechanism for generating solutions
            ...
            if any('\\boxed{' in sol for sol in solutions):
                break  # Exit if a valid solution is found
