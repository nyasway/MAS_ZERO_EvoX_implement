...
import examples.aflow.math.optimized.round_7.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        validation = await self.programmer(problem=problem, analysis=solution['response'])
        
        if validation['output'] == solution['response']:
            return solution['response']
        else:
            return "Solution validation failed. Please review the problem and solution."
